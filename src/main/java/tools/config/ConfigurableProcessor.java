...
public class ConfigurableProcessor {
    ...
    private static final Logger log = LogManager.getLogger(ConfigurableProcessor.class);
     ...
     * Transformation is done using {@link tools.config.PropertyTransformerFactory}
     *
